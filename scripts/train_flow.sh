...
train_path=$root_path/result/train/verX_occ25/flow
...
--batch_size 8 --master_batch 8 --num_workers 4 --gpus 0 --flow_model $train_path \
--lr 5e-4 --lr_step 12,20 --ninput 5 --num_epochs 30
