...
train_path=$root_path/result/train/jhmdb25/rgb
...
--batch_size 8 --master_batch 8 --num_workers 4 --gpus 0 --save_all \
--rgb_model $train_path --load_model $train_path_rgb/model_last.pth \
--lr 5e-4 --lr_step 8,16 --num_epochs 20 --start_epoch 8 \
