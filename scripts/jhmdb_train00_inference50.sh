...
result_path_rgb=$root_path/result/inference/jhmdb50_train00_rgb
result_path_flow=$root_path/result/inference/jhmdb50_train00_flow
result_path_both=$root_path/result/inference/jhmdb50_train00_both
origin_data="JHMDB_50"
target_data="JHMDB"
