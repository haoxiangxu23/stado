...
mv JHMDB_00 JHMDB
cd ..
mkdir -p occ_inference_results/occ50_train25_rgb
mkdir -p occ_inference_results/occ50_train25_flow
mkdir -p occ_inference_results/occ50_train25_both
cd src
...
--inference_dir ../occ_inference_results/occ50_train25_rgb/
# fream 
...
--inference_dir ../occ_inference_results/occ50_train25_flow/
# fream 
python3 ACT.py --task frameAP --K 7 --th 0.5 --dataset hmdb --split 1 \
--inference_dir ../occ_inference_results/occ50_train25_flow/
# vidio
...
--rgb_model ../results/trained_model/rgb_16e_occ25.pth \
--flow_model ../results/trained_model/flow_15e_occ25.pth \
--inference_dir ../occ_inference_results/occ50_train25_both/
# fream 
python3 ACT.py --task frameAP --K 7 --th 0.5 --dataset hmdb --split 1 \
--inference_dir ../occ_inference_results/occ50_train25_both/
# vidio
