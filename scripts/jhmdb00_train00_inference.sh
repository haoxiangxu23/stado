...
mv JHMDB_00 JHMDB
cd ..
mkdir -p occ_inference_results/occ00_train00_rgb
mkdir -p occ_inference_results/occ00_train00_flow
mkdir -p occ_inference_results/occ00_train00_both
cd src
...
--inference_dir ../occ_inference_results/occ00_train00_rgb/
# fream 
...
--inference_dir ../occ_inference_results/occ00_train00_flow/
# fream 
python3 ACT.py --task frameAP --K 7 --th 0.5 --dataset hmdb --split 1 \
--inference_dir ../occ_inference_results/occ00_train00_flow/
# vidio
...
--rgb_model ../models/hmdb_s1_dla34_K7_rgb_coco.pth \
--flow_model ../models/hmdb_s1_dla34_K7_flow_coco.pth \
--inference_dir ../occ_inference_results/occ00_train00_both/
# fream 
python3 ACT.py --task frameAP --K 7 --th 0.5 --dataset hmdb --split 1 \
--inference_dir ../occ_inference_results/occ00_train00_both/
# vidio
